...
public class GuiProveedores extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Registrar Proveedores:");
    ...
    private void registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarActionPerformed
        ...
        String nombrePrv = nombre.getText();
        String direccionPrv = direccion.getText();
        String telefonoPrv = telefono.getText();
        p.Agregar4(nombrePrv,direccionPrv,telefonoPrv);
        iniciar();
    ...
    private void actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_actualizarActionPerformed
        try {
            ...
            PreparedStatement pst = cn.prepareStatement("UPDATE PROVEEDOR SET NOM_PRV=?,DIR_PRV=?,TEL_PRV=? WHERE COD_PRV=?");
    ...
    private void eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarActionPerformed
        ...
        try {
            ...
            PreparedStatement pst = cn.prepareStatement("DELETE FROM PROVEEDOR WHERE COD_PRV='" + cod + "'");
    ...
    private void TablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaMouseClicked
        ...
        telefono.setText(model.getValueAt(Tabla.getSelectedRow(), 3) + " ");
