...
public class GuiTienda1 extends javax.swing.JFrame {
 Connection cn;
    /**
...
pst.executeUpdate();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GuiTienda1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GuiTienda1().setVisible(true);
            }
        });
    }
